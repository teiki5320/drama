# À CONTRE-JOUR (逆光) — HISTOIRE

> Drama romantique mobile. 112 jours, 16 semaines, 5 fins.
> Ce document contient uniquement la narration : pitch, personnages,
> structure, scènes non-négociables, scénario jour par jour et épilogues.
> Les mécaniques de jeu, specs techniques et catalogues vivent ailleurs.
...
3. **STRUCTURE EN 16 SEMAINES** — Les 6 actes
4. **SCÈNES NON-NÉGOCIABLES** — Dialogues canoniques
5. **SCÉNARIO COMPLET J1 → J112**
6. **LES 5 ÉPILOGUES**
